...
export default function Hero() {
  return (
    ...
    >
      <Box sx={{ maxWidth: 1140, mx: 'auto', px: { xs: 2, sm: 3 }, display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', gap: 2, py: 4 }}>
        <RevealOnScroll sx={{ maxWidth: 720 }}>
          <Box
            className="eyebrow"
            sx={{ pl: 1, borderLeft: '3px solid #ffd200', mb: 2, display: 'inline-block' }}
          >
          ...
          <Typography
            ...
            sx={{
              ...
              fontSize: { xs: 'clamp(1.8rem,7vw,2.6rem)', sm: 'clamp(2.8rem,5.2vw,5rem)' },
              fontWeight: 580, lineHeight: 0.95, letterSpacing: '-0.03em',
              my: 2.2,
            }}
          >
          ...
          <Grid
            container
            sx={{
              mt: 4, pt: 2, borderTop: '1px solid rgba(26,26,26,0.08)',
                ...
                <Box sx={{ textAlign: 'center', px: 1 }}>
                  <Typography
                    sx={{
                      ...
                      fontSize: { xs: '1.5rem', sm: '1.9rem' }, lineHeight: 1,
                      color: '#b55a3a', fontWeight: 600,
                    }}
                  >
                    {s.dt}
                  </Typography>
